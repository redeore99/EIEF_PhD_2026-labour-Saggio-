...
random starting values, retaining the global optimum. Standard errors are the
square roots of the diagonal of the inverse numerical Hessian of $-\ell$; the SE
for $\delta$ is obtained from that of $\log\delta$ by the delta method. The code
is in \texttt{kw\_estimate.py}.
...
$\alpha_1$ (white-collar intercept)        & $0.4234$  & $0.0585$ \\
$\beta_1$ (return to education, WC)         & $0.3681$  & $0.0800$ \\
$\gamma_1$ (return to WC experience)        & $0.0607$  & $0.0844$ \\
$\alpha_2$ (blue-collar intercept)          & $0.4237$  & $0.0422$ \\
$\beta_2$ (return to education, BC)          & $0.1215$  & $0.0635$ \\
$\gamma_2$ (return to BC experience)        & $0.3513$  & $0.0792$ \\
$\delta$ (discount factor)                  & $0.8395$  & $0.3818$ \\ \midrule
\multicolumn{3}{l}{Log-likelihood $=-10{,}734.24$,\quad $N=5{,}000$}\\
\bottomrule
\end{tabular}
\end{table}

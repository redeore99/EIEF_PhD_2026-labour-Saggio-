...
\begin{itemize}
\item {\footnotesize One of (if not THE) most powerful ideas in economics: }{\footnotesize\emph{Self-selection}}{\footnotesize\medskip{}
}{\footnotesize\par}
...
\[
(\epsilon_{id},v_{i})^{\prime}|X_{i}\sim N\left(0,\left[\begin{smallmatrix}\sigma^{2}_{d} & \rho_{d}\sigma_{d}\\
\rho_{d}\sigma_{d} & 1
...
\item {\scriptsize Mills ratio is a }{\scriptsize\uline{control function}}{\scriptsize{}
...
side), or factors that interact with women's characteristics (left-hand
side) \medskip{}
}{\small\par}
...
\item {\small\uline{Flat of the curve }}{\small explanation: High-use areas
...
\item {\footnotesize Intensive intervention (surgery; bypass or angioplasty)
\medskip{}
}{\footnotesize\par}
\end{enumerate}
...
{\scriptsize\par}\begin{itemize}
\item {\scriptsize Possibly multiple equilibria \medskip{}
}{\scriptsize\par}
...
\item {\scriptsize Heckman, James and Bo Honor\'e (1990). \textquotedblleft The
